...
cleanup() {
  unset WEBHOOK_TOKEN WEBHOOK_TOKEN_B64
}
...
updates = {
    ...
    "V2COMPAT_OPENVIDU_WEBHOOK_ENDPOINT": "https://server.courseultra.com/webhooks/openvidu",
...
REMOTE_SCRIPT
  ...
  "root@$MASTER_IP" \
  'read -r TOKEN_B64; export TOKEN_B64; bash -s'
